...
const achievements = [
  { year: '2025', type: '학술대회', title: '한국전기전자학회 하계학술대회 제1저자 발표', detail: '야간 및 악천후 환경에서의 딥러닝 기반 실시간 차선 인식 시스템' },
  { year: '2025', type: '학술대회', title: '제27회 전자정보통신 학술대회 제1저자 발표', detail: '야간 및 악천후 환경에서의 차선 인식용 세그멘테이션 모델 비교' },
